...
const init = async function (msg,args){
    ...
    NSFW(imgOrigin,5).then( async predictions => {
        const
            ...
            ,P=(predictions.find(x=> x.className == 'Porn') || {}).probability    || 0
            ,S=(predictions.find(x=> x.className == 'Sexy') || {}).probability    || 0
            
            ,D=(predictions.find(x=> x.className == 'Drawing') || {}).probability || 0
            ,N=(predictions.find(x=> x.className == 'Neutral') || {}).probability  || 0;
