...
let d6mo  = message.guild.roles.find(r=>r.id==='418887056262037505');
let d5mo  = message.guild.roles.find(r=>r.id==='418887120896393217');
let d4mo  = message.guild.roles.find(r=>r.id==='418887153662164996');
let d3mo  = message.guild.roles.find(r=>r.id==='418887192790958090');
let d2mo  = message.guild.roles.find(r=>r.id==='418887224642502668');
let d1mo  = message.guild.roles.find(r=>r.id==='418887258699988992');
let poof  = message.guild.roles.find(r=>r.id==='544641663348506673');

let demodemo = [d6mo,d5mo,d4mo,d3mo,d2mo,d1mo,poof]
...
for(i in demodemo){
 let rolId = demodemo[i] 
 let rolIdNext = demodemo[i- -1] 
...
let stickernames = await DB.cosmetics.find({id:{$in:pushmo},type:"sticker"},{name:1,_id: 0 });
